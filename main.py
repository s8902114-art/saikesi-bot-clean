...
ENGULF_SHORT_ENABLED = False  # ★2026-08-02暫停(不是判死):容錯僅4.5🔴(全策略最薄),且它一支佔live訊號量44%
...
MIN_MOVER_VOLCCY    = 3_000_000.0   # ★2026-09-04 同步下調(理由見 LIQ_POOL_MIN_VOLCCY);單位已修為USDT
...
LIQ_POOL_MIN_VOLCCY  = 3_000_000.0    # ★2026-09-04 下調 10M→3M(用戶:「OI儀表板本來就小幣為主,
...
#   3M → 幣池約161幣(涵蓋約70%的警報幣),仍是警報幣p10(0.6M)的5倍,保留最基本的可成交性。
...
GLOBAL_TIMESTOP_H   = 12   # ★2026-08-01 24→12h(用戶:「不要那種靠少數單贏的,等到來帳戶都沒錢了」)。
